declare module '@tabler/icons-vue' {
  ...
  export const IconLoadBalancer: DefineComponent
  export const IconShieldCheck: DefineComponent
  export const IconShieldDollar: DefineComponent
  export const IconFileCertificate: DefineComponent
  export const IconFileInvoice: DefineComponent
  export const IconArrowsRightLeft: DefineComponent;
  export const IconMessage: DefineComponent
  export const IconFileAlert: DefineComponent;
  export const IconSettings: DefineComponent;
  export const IconMessageCode: DefineComponent;
  export const IconMessageCode: DefineComponent;
  export const IconArrowUpRight: DefineComponent;
  export const IconArrowDownLeft: DefineComponent;
